...
from app.config import SHOPIFY_CLIENT_SECRET
...
# 🔐 VERIFY OAUTH HMAC
def verify_shopify_hmac(params: dict[str, str], provided_hmac: str) -> bool:
    filtered = {
...
# 🔐 VERIFY WEBHOOK HMAC
def verify_webhook_hmac(raw_body: bytes, provided_hmac: str | None) -> bool:
